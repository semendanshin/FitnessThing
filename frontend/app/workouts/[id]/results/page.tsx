        ...
        return (
            <section className="flex flex-col gap-2">
                <div className="flex flex-row items-center justify-between">
                    <label className="text-sm font-bold">Упражнения</label>
                    <label className="text-sm font-bold">Лучший сет</label>
                </div>
                    ...
                    {workoutDetails?.exerciseLogs?.map(
                        (workoutExercise, index) => (
                            ...
                            >
                                ...
                                <label className="text-sm font-light w-fit">
